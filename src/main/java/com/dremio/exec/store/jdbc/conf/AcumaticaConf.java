...
@SourceType(value = "AcumaticaARP", label = "Acumatica",uiConfig = "acumatica-layout.json")
public class AcumaticaConf extends AbstractArpConf<AcumaticaConf> {
  private static final String ARP_FILENAME = "arp/implementation/acumatica-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.acumatica.AcumaticaDriver";
